# ./prepAtlasMAP.sh <atlas img> <atlas img scale * chart unit> <atlas page url template>
#

# Gebrauch:
# xsltproc <xsl> <xml> | [ LANG=<country> ] ./prepHTMLArea.sh <atlas img> <atlas img/atlas pdf size ratio> <atlas page url template>
#
# xsltproc Atlas.xsl atlas-stereographic-northern-picker.xml |\
#	LANG=de ./prepAtlasMAP.sh atlas-stereographic-northern.png 1.7353 "pdf/atlas-stereographic-northern-page%03d.pdf"
#
