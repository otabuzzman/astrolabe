...
public class Model extends Main implements Cloneable {
	...
	public static int[] condense( YMDType ymd ) throws ParameterNotValidException {
		if ( ymd == null ) {
			throw new ParameterNotValidException() ;
		}

		return new int[] { ymd.getY(), ymd.getM(), ymd.getD() } ;
	}
