...
public class CatalogADC5109Record extends astrolabe.model.CatalogADC5109Record implements CatalogRecord {
	...
	public void register() {
		...
		AstrolabeRegistry.registerName( key, SKY2000 ) ;
		key = m.message( ApplicationConstant.LK_ADC5109_ID ) ;
		AstrolabeRegistry.registerName( key, ID ) ;
		...
		AstrolabeRegistry.registerName( key, m_HD ) ;
		key = m.message( ApplicationConstant.LK_ADC5109_U_HD ) ;
		AstrolabeRegistry.registerName( key, u_HD ) ;
		...
		AstrolabeRegistry.registerName( key, m_SAO ) ;
		...
		AstrolabeRegistry.registerName( key, m_DM ) ;
		key = m.message( ApplicationConstant.LK_ADC5109_U_DM ) ;
		AstrolabeRegistry.registerName( key, u_DM ) ;
		...
		AstrolabeRegistry.registerName( key, WDS ) ;
		key = m.message( ApplicationConstant.LK_ADC5109_M_WDS ) ;
		AstrolabeRegistry.registerName( key, m_WDS ) ;
		key = m.message( ApplicationConstant.LK_ADC5109_U_WDS ) ;
		AstrolabeRegistry.registerName( key, u_WDS ) ;
		...
		AstrolabeRegistry.registerName( key, u_PPM ) ;
		key = m.message( ApplicationConstant.LK_ADC5109_ID_MERG ) ;
		AstrolabeRegistry.registerName( key, ID_merg ) ;
		...
		AstrolabeRegistry.registerName( key, Vname ) ;
		...
		AstrolabeRegistry.registerName( key, e_pos ) ;
		key = m.message( ApplicationConstant.LK_ADC5109_F_POS ) ;
		AstrolabeRegistry.registerName( key, f_pos ) ;
		key = m.message( ApplicationConstant.LK_ADC5109_R_POS ) ;
		AstrolabeRegistry.registerName( key, r_pos ) ;
		...
		AstrolabeRegistry.registerName( key, r_pm ) ;
		key = m.message( ApplicationConstant.LK_ADC5109_RV ) ;
		AstrolabeRegistry.registerName( key, RV ) ;
		key = m.message( ApplicationConstant.LK_ADC5109_R_RV ) ;
		AstrolabeRegistry.registerName( key, r_RV ) ;
		...
		AstrolabeRegistry.registerName( key, r_Plx ) ;
		key = m.message( ApplicationConstant.LK_ADC5109_GCI_X ) ;
		AstrolabeRegistry.registerName( key, GCI_X ) ;
		key = m.message( ApplicationConstant.LK_ADC5109_GCI_Y ) ;
		AstrolabeRegistry.registerName( key, GCI_Y ) ;
		key = m.message( ApplicationConstant.LK_ADC5109_GCI_Z ) ;
		AstrolabeRegistry.registerName( key, GCI_Z ) ;
		...
		AstrolabeRegistry.registerName( key, Vder ) ;
		key = m.message( ApplicationConstant.LK_ADC5109_E_VMAG ) ;
		AstrolabeRegistry.registerName( key, e_Vmag ) ;
		key = m.message( ApplicationConstant.LK_ADC5109_F_VMAG ) ;
		AstrolabeRegistry.registerName( key, f_Vmag ) ;
		...
		AstrolabeRegistry.registerName( key, Bmag ) ;
		...
		AstrolabeRegistry.registerName( key, e_Bmag ) ;
		key = m.message( ApplicationConstant.LK_ADC5109_F_BMAG ) ;
		AstrolabeRegistry.registerName( key, f_Bmag ) ;
		key = m.message( ApplicationConstant.LK_ADC5109_R_BMAG ) ;
		AstrolabeRegistry.registerName( key, r_Bmag ) ;
		key = m.message( ApplicationConstant.LK_ADC5109_UMAG ) ;
		AstrolabeRegistry.registerName( key, Umag ) ;
		...
		AstrolabeRegistry.registerName( key, orbPer ) ;
