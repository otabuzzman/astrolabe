...
public class QuantityDate extends Model implements Quantity {

	private Circle circle ;
	private Sun sun ;

	private CAADate year ;
	...
	public QuantityDate( Circle circle, Sun sun, CAADate epoch ) throws ParameterNotPlausibleException {
		int y ;
		...
		y = (int) epoch.Year() ;
		year = new CAADate( y, 1, 1, DateHelper.isDateGregorian( y, 1, 1 ) ) ;
	...
	private double spanN2JD( int n ) {
		return year.Julian()+Math.remainder( jd0-year.Julian()+n*span, 365 ) ;
	}
}
